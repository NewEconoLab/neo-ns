...
namespace DApp
{
    public class nns_domaincenter : SmartContract
    {
        ...
        static readonly byte[] jumpContract = Helper.ToScriptHash("AZvvZk68M8PG4tfxV6o3a19w8TFM626EzG");//注意 script_hash 是反序的
                                                                                                        //跳板合约0x348387116c4a75e420663277d9c02049907128c7
        //通知 域名信息變更
